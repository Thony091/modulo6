			...
			<div class="row mt-4 d-flex justify-content-around">			
				...
				<div class="card col-xs-12 col-sm-6 col-md-3" >
					...
					<div class="card-body">							
						...
						<a href="${pageContext.request.contextPath}/capacitacion/new"	class="btn btn-primary d-grid gap-2 mt-2">Crear Capacitacion</a>
						<a href="${pageContext.request.contextPath}/capacitaciones"	class="btn btn-primary d-grid gap-2 mt-2">Listar Capacitaciones</a>
					</div>
				</div>
